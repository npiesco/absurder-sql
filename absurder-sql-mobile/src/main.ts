...
import installer from './NativeAbsurderSql';
...
export * from './generated/absurder_sql_mobile';

// Export the high-level wrapper API
export { AbsurderDatabase, openDatabase } from './AbsurderDatabase';
export type { QueryResult, DatabaseConfig, EncryptionConfig, Migration } from './AbsurderDatabase';

// Now import the bindings so we can:
// - intialize them
// - export them as namespaced objects as the default export.
import * as absurder_sql_mobile from './generated/absurder_sql_mobile';
...
if (!initialized) {
  absurder_sql_mobile.default.initialize();
  initialized = true;
}
