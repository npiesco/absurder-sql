...
#include "absurder-sql.h"

namespace jsi = facebook::jsi;
namespace react = facebook::react;

// Automated testing checks Java_com_absurdersql_AbsurderSqlModule and absurdersql
// by comparing the whole line here.
/*
Java_com_absurdersql_AbsurderSqlModule_nativeMultiply(JNIEnv *env, jclass type, jdouble a, jdouble b) {
    return absurdersql::multiply(a, b);
}
*/

// Installer coming from AbsurderSqlModule
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_absurdersql_AbsurderSqlModule_nativeInstallRustCrate(
    JNIEnv *env,
    jclass type,
    jlong rtPtr,
    ...
    return absurdersql::installRustCrate(*runtime, jsCallInvoker);
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_absurdersql_AbsurderSqlModule_nativeCleanupRustCrate(JNIEnv *env, jclass type, jlong rtPtr) {
    auto runtime = reinterpret_cast<jsi::Runtime *>(rtPtr);
    return absurdersql::cleanupRustCrate(*runtime);
}