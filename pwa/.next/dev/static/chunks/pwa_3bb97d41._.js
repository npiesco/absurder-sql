...
"[project]/pwa/app/db/grep/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function DataGrepContent() {
    ...
    const currentDbName = (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$lib$2f$db$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDatabaseStore"])({
        "DataGrepContent.useDatabaseStore[currentDbName]": (state)=>state.currentDbName
    }["DataGrepContent.useDatabaseStore[currentDbName]"]);
    ...
    const [resultLimit, setResultLimit] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DataGrepContent.useEffect": ()=>{
            ...
            ;
            const checkTestDb = {
                "DataGrepContent.useEffect.checkTestDb": ()=>{
            ...
            return ({
                "DataGrepContent.useEffect": ()=>clearInterval(interval)
            })["DataGrepContent.useEffect"];
        }
    }["DataGrepContent.useEffect"], [
        windowTestDb
    ...
    const performSearch = async ()=>{
      ...
      `);
            ...
            for (const tableName of tables){
                ...
                const columns = columnsResult.rows.map((row_0)=>getValue(row_0.values[1]));
                // Get all rows from this table
                const dataResult = await activeDb.execute(`SELECT rowid, * FROM ${tableName}`);
                // Search through each row
                for (const row_1 of dataResult.rows){
                    if (results.length >= MAX_RESULTS) {
                        setResultLimit(true);
                        break;
                    }
                    const rowId = getValue(row_1.values[0]);
                    const rowData = {};
                    // Check each column value
                    for(let i = 0; i < columns.length; i++){
                        const columnName = columns[i];
                        const value = getValue(row_1.values[i + 1]); // +1 because rowid is first
            ...
            console.error('Data grep search error:', err_0);
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardTitle"], {
                            children: [
                                "Results",
                                searchResults.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                        children: searchResults.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: searchResults.map((result, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableRow"], {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                                        ...
                                                        children: result.matchedValue === null ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                            className: "text-muted-foreground",
                                                            children: "NULL"
                                                        }, void 0, false, {
                                                            fileName: "[project]/pwa/app/db/grep/page.tsx",
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                                        ...
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            className: "truncate",
                                                            children: [
                                                                Object.entries(result.rowData).slice(0, 3).map(([key, value_0])=>`${key}: ${value_0 === null ? 'NULL' : String(value_0)}`).join(', '),
...
_s(DataGrepContent, "DMyeo+VRT/NzEuxLqpakFuvT/j4=", false, function() {
    return [
...
function DataGrepPage() {
    ...
    if ($[0] !== "96b24bdc190da302b9d8239097953589bee3ef01ffb47f5c8f48cf8e4ea763fd") {
        for(let $i = 0; $i < 2; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "96b24bdc190da302b9d8239097953589bee3ef01ffb47f5c8f48cf8e4ea763fd";
    }
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$lib$2f$db$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDatabaseStore"])(_DataGrepPageUseDatabaseStore);
    let t0;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t0 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(DataGrepContent, {}, void 0, false, {
            fileName: "[project]/pwa/app/db/grep/page.tsx",
            lineNumber: 317,
            columnNumber: 10
        }, this);
...
_s1(DataGrepPage, "MQ1nmHSpOst7iIREU9ieg5zbz0c=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$lib$2f$db$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDatabaseStore"]
    ];
});
_c1 = DataGrepPage;
function _DataGrepPageUseDatabaseStore(state) {
    return state.currentDbName;
}
var _c, _c1;
__turbopack_context__.k.register(_c, "DataGrepContent");
__turbopack_context__.k.register(_c1, "DataGrepPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=pwa_3bb97d41._.js.map