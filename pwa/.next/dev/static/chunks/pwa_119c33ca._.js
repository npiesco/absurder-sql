...
"[project]/pwa/app/db/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function DatabaseManagementPage() {
    _s();
    const { db, currentDbName, loading, status, tableCount, showSystemTables, _hasHydrated, setDb, setCurrentDbName, setLoading, setStatus, setTableCount, setShowSystemTables } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$lib$2f$db$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDatabaseStore"])();
    const [newDbName, setNewDbName] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    const [deleteDialogOpen, setDeleteDialogOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [isDragOver, setIsDragOver] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [selectedFile, setSelectedFile] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [dbInfo, setDbInfo] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const fileInputRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DatabaseManagementPage.useEffect": ()=>{
            if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
            ;
            if (window.Database) return; // Already initialized
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DatabaseManagementPage.useEffect": ()=>{
            ...
            console.log('[PWA] loadDatabase useEffect triggered', {
                wasmReady,
            ...
            async function loadDatabase() {
                try {
                    ...
                    console.error('[PWA] Failed to load database:', err_0);
                    setStatus(`Error loading database: ${err_0.message}`);
                }
            }
            loadDatabase();
        }
    ...
    const handleCreateDatabase = async ()=>{
        ...
        if (!newDbName.trim() || !Database_1) return;
        try {
            ...
            // Create new database
            const newDb = await Database_1.newDatabase(normalizedName);
            setDb(newDb);
    ...
    const handleExport = async ()=>{
        ...
        try {
            ...
            setStatus(`Export error: ${err_2.message}`);
        }
    };
    const handleImport = async ()=>{
        const Database_2 = window.Database;
        if (!Database_2) return;
        ...
        try {
            ...
            const newDb_0 = await Database_2.newDatabase(dbName);
            // Import the data
            await newDb_0.importFromFile(uint8Array);
            // Close and reopen
            await newDb_0.close();
            const reopenedDb = await Database_2.newDatabase(dbName);
            setDb(reopenedDb);
            setCurrentDbName(dbName);
            window.testDb = reopenedDb;
            setStatus('Import complete');
            setSelectedFile(null);
            if (fileInputRef.current) fileInputRef.current.value = '';
        } catch (err_3) {
            setStatus(`Import error: ${err_3.message}`);
        }
    };
    const handleRefreshInfo = async ()=>{
        if (!db) return;
        try {
            const query = showSystemTables ? "SELECT type, name FROM sqlite_master ORDER BY name" : "SELECT type, name FROM sqlite_master WHERE name NOT LIKE 'sqlite_%' ORDER BY name";
            ...
            setStatus(`Error: ${err_4}`);
            setDbInfo(`Error executing query: ${err_4}`);
        }
    };
    ...
    const handleDelete = async ()=>{
        const Database_3 = window.Database;
        if (!db || !Database_3) return;
        try {
            await db.close();
            // Delete using WASM API which cleans up all storage
            await Database_3.deleteDatabase(currentDbName);
            ...
            setStatus(`Delete error: ${err_5.message}`);
        }
    };
    ...
    const handleDrop = async (e_1)=>{
        e_1.preventDefault();
        e_1.stopPropagation();
        setIsDragOver(false);
        const files = Array.from(e_1.dataTransfer.files);
        if (files.length === 0) return;
        const file_0 = files[0];
        if (!file_0.name.endsWith('.db') && !file_0.name.endsWith('.sqlite') && !file_0.name.endsWith('.sqlite3')) {
            setStatus('Error: Please drop a valid .db file');
            return;
        }
        const Database_4 = window.Database;
        if (!db || !Database_4) {
            setStatus('Error: Database not initialized');
            return;
        }
        try {
            const arrayBuffer_0 = await file_0.arrayBuffer();
            const uint8Array_0 = new Uint8Array(arrayBuffer_0);
            await db.close();
            const newDb_1 = await Database_4.newDatabase(currentDbName);
            await newDb_1.importFromFile(uint8Array_0);
            await newDb_1.close();
            const reopenedDb_0 = await Database_4.newDatabase(currentDbName);
            setDb(reopenedDb_0);
            window.testDb = reopenedDb_0;
            setStatus('Import complete');
            setSelectedFile(null);
        } catch (err_6) {
            setStatus(`Import error: ${err_6.message}`);
        }
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                ...
                fileName: "[project]/pwa/app/db/page.tsx",
                lineNumber: 282,
                columnNumber: 7
            }, this),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                id: "status",
                className: "mb-4 p-3 bg-blue-50 rounded",
                children: status
            }, void 0, false, {
                fileName: "[project]/pwa/app/db/page.tsx",
                lineNumber: 284,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                onDrop: handleDrop,
                className: `mb-6 p-8 border-2 border-dashed rounded-lg text-center transition-colors ${isDragOver ? 'border-blue-500 bg-blue-50 drag-over' : 'border-gray-300 bg-gray-50'}`,
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    ...
                    children: isDragOver ? 'Drop your .db file here' : 'Drag and drop a .db file here to import'
                }, void 0, false, {
                    fileName: "[project]/pwa/app/db/page.tsx",
                    lineNumber: 290,
                    columnNumber: 9
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            "Current database: ",
                                            currentDbName || 'None (create or import a database)'
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/pwa/app/db/page.tsx",
                                        lineNumber: 302,
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                        ...
                                        className: "hidden",
                                        onChange: (e_2)=>setSelectedFile(e_2.target.files?.[0] || null)
                                    }, void 0, false, {
                                        fileName: "[project]/pwa/app/db/page.tsx",
                                        lineNumber: 306,
                                        columnNumber: 13
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogContent"], {
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogHeader"], {
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogDescription"], {
                                                                children: "Enter a name for your new database"
                                                            }, void 0, false, {
                                                                fileName: "[project]/pwa/app/db/page.tsx",
                                                                lineNumber: 315,
                                                                columnNumber: 19
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$components$2f$ui$2f$input$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Input"], {
                                                        ...
                                                        value: newDbName,
                                                        onChange: (e_3)=>setNewDbName(e_3.target.value)
                                                    }, void 0, false, {
                                                        fileName: "[project]/pwa/app/db/page.tsx",
                                                        lineNumber: 317,
                                                        columnNumber: 17
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                        ...
                                        className: "w-full",
                                        variant: "outline",
                                        children: "Select File to Import"
                                    }, void 0, false, {
                                        fileName: "[project]/pwa/app/db/page.tsx",
                                        lineNumber: 328,
                                        columnNumber: 13
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogHeader"], {
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogDescription"], {
                                                                children: "Are you sure you want to delete this database?"
                                                            }, void 0, false, {
                                                                fileName: "[project]/pwa/app/db/page.tsx",
                                                                lineNumber: 345,
                                                                columnNumber: 19
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardDescription"], {
                                        children: "Current database statistics"
                                    }, void 0, false, {
                                        fileName: "[project]/pwa/app/db/page.tsx",
                                        lineNumber: 358,
                                        columnNumber: 13
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                    ...
                                                    onChange: (e_4)=>setShowSystemTables(e_4.target.checked),
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                                    htmlFor: "showSystemTables",
                                                    className: "text-sm cursor-pointer",
                                                    children: "Show system tables (sqlite_*)"
                                                }, void 0, false, {
                                                    fileName: "[project]/pwa/app/db/page.tsx",
                                                    lineNumber: 368,
                                                    columnNumber: 17
                                        ...
                                        dbInfo && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("pre", {
                                            className: "mt-4 p-3 bg-gray-100 dark:bg-gray-800 rounded text-sm whitespace-pre-wrap font-mono",
                                            children: dbInfo
                                        }, void 0, false, {
                                            fileName: "[project]/pwa/app/db/page.tsx",
                                            lineNumber: 375,
...
_s(DatabaseManagementPage, "RKIwfqiz2Yb3+Ei/HwSer08Gs/M=", false, function() {
    return [
...
_c = DatabaseManagementPage;
var _c;
__turbopack_context__.k.register(_c, "DatabaseManagementPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=pwa_119c33ca._.js.map