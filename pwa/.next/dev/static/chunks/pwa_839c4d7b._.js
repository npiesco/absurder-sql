...
"[project]/pwa/app/db/diagram/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ERDiagramPage() {
    _s();
    const { db, setDb, currentDbName, setCurrentDbName, _hasHydrated } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$lib$2f$db$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDatabaseStore"])();
    ...
    const [edges, setEdges] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const [scale, setScale] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(1);
    ...
    const [exportMenuOpen, setExportMenuOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const diagramRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ERDiagramPage.useEffect": ()=>{
            ...
            ;
            const checkTestDb = {
                "ERDiagramPage.useEffect.checkTestDb": ()=>{
            ...
            return ({
                "ERDiagramPage.useEffect": ()=>clearInterval(interval)
            })["ERDiagramPage.useEffect"];
        }
    }["ERDiagramPage.useEffect"], [
        windowTestDb
    ...
    const loadDiagram = async ()=>{
        ...
        try {
            // Get all tables
            const tablesResult = await activeDb.execute("SELECT name FROM sqlite_master WHERE type='table' AND name NOT LIKE 'sqlite_%' ORDER BY name");
            const tableNames = tablesResult.rows.map((row)=>row.values[0].value);
            ...
            for(let i = 0; i < tableNames.length; i++){
                ...
                for (const fkRow of fkResult.rows){
                    const toTable = fkRow.values[2].value;
                    const fromColumn = fkRow.values[3].value;
                    const toColumn = fkRow.values[4].value;
                    allEdges.push({
                        from: tableName,
                        to: toTable,
                        fromColumn,
            ...
            console.error('[DiagramPage] Error loading diagram:', err_0);
            setError(`Failed to load diagram: ${err_0}`);
        } finally{
            setLoading(false);
        }
    };
    ...
    const zoomOut = ()=>{
        setScale((prev_0)=>Math.max(prev_0 - 0.2, 0.2));
    };
    const resetZoom = ()=>{
        setScale(1);
    };
    // Handle node click
    const handleNodeClick = async (tableName_0)=>{
        if (!activeDb) return;
        try {
            const result = await activeDb.execute(`PRAGMA table_info(${tableName_0})`);
            const columns = result.rows.map((row_1)=>({
                    name: row_1.values[1].value,
                    type: row_1.values[2].value,
                    notnull: row_1.values[3].value === 1,
                    dflt_value: row_1.values[4].value,
                    pk: row_1.values[5].value === 1
                }));
            setTableColumns(columns);
            setSelectedTable(tableName_0);
        } catch (err_1) {
            console.error('[DiagramPage] Error loading table details:', err_1);
        }
    };
    // Export as PNG
    const exportAsPNG = async ()=>{
        ...
        try {
            ...
            const html2canvas = (await __turbopack_context__.A("[project]/pwa/node_modules/html2canvas/dist/html2canvas.js [app-client] (ecmascript, async loader)")).default;
            ...
            console.error('[DiagramPage] Error exporting PNG:', err_2);
            setError(`Failed to export PNG: ${err_2}`);
        }
    };
    // Export as SVG
    const exportAsSVG = ()=>{
...
`;
            ...
            edges.forEach((edge)=>{
                ...
                const toNode = tables.find((t_0)=>t_0.name === edge.to);
                if (fromNode && toNode) {
            ...
            link_0.download = `er-diagram-${Date.now()}.svg`;
            link_0.href = url_0;
            ...
            console.error('[DiagramPage] Error exporting SVG:', err_3);
            setError(`Failed to export SVG: ${err_3}`);
        }
    };
    if (initializing) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                ...
                fileName: "[project]/pwa/app/db/diagram/page.tsx",
                lineNumber: 296,
                columnNumber: 9
            }, this)
        }, void 0, false, {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            tables.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                className: "p-8 text-center",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    className: "text-muted-foreground",
                    children: "No tables found in the database. Create tables to see the ER diagram."
                }, void 0, false, {
                    fileName: "[project]/pwa/app/db/diagram/page.tsx",
                    lineNumber: 331,
                    columnNumber: 11
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
                            width: "1200",
                            height: "800",
                            style: {
                                position: 'absolute',
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("defs", {
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("marker", {
                                        id: "arrowhead",
                                        markerWidth: "10",
                                        markerHeight: "10",
                                        refX: "9",
                                        refY: "3",
                                        orient: "auto",
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("polygon", {
                                            points: "0 0, 10 3, 0 6",
                                            fill: "#666"
                                        }, void 0, false, {
                                            fileName: "[project]/pwa/app/db/diagram/page.tsx",
                                ...
                                edges.map((edge_0, idx)=>{
                                    const fromNode_0 = tables.find((t_1)=>t_1.name === edge_0.from);
                                    const toNode_0 = tables.find((t_2)=>t_2.name === edge_0.to);
                                    if (!fromNode_0 || !toNode_0) return null;
                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("line", {
                                        "data-edge-type": "foreign-key",
                                        "data-fk-edge": `${edge_0.from}->${edge_0.to}`,
                                        x1: fromNode_0.x + 100,
                                        y1: fromNode_0.y + 60,
                                        x2: toNode_0.x + 100,
                                        y2: toNode_0.y + 60,
                        ...
                        tables.map((table_0)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                "data-node-type": "table",
                                "data-table-node": table_0.name,
                                onClick: ()=>handleNodeClick(table_0.name),
                                style: {
                                    position: 'absolute',
                                    left: table_0.x,
                                    top: table_0.y,
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogHeader"], {
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogDescription"], {
                                    children: "Table structure and columns"
                                }, void 0, false, {
                                    fileName: "[project]/pwa/app/db/diagram/page.tsx",
                                    lineNumber: 392,
                                    columnNumber: 13
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: tableColumns.map((col_0, idx_0)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                col_0.pk && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                ...
                                                col_0.notnull && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    className: "ml-1 text-xs bg-yellow-100 text-yellow-800 px-2 py-0.5 rounded",
                                                    children: "NOT NULL"
                                                }, void 0, false, {
                                                    fileName: "[project]/pwa/app/db/diagram/page.tsx",
                                                    lineNumber: 404,
...
_s(ERDiagramPage, "1WLiDa3cSsPGAkyCsasJ84ArI14=", false, function() {
    return [
...
_c = ERDiagramPage;
var _c;
__turbopack_context__.k.register(_c, "ERDiagramPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=pwa_839c4d7b._.js.map