...
async fn test_database_creation() {
    ...
    match db {
        Ok(_) => web_sys::console::log_1(&"✓ Database creation test passed".into()),
        Err(e) => {
            web_sys::console::log_1(&format!("✗ Database creation failed: {:?}", e).into());
...
async fn test_create_table() {
    ...
    web_sys::console::log_1(&"✓ Create table test passed".into());
}
...
async fn test_insert_data() {
    ...
    web_sys::console::log_1(&"✓ Insert data test passed".into());
}
...
async fn test_select_data() {
    ...
    web_sys::console::log_1(&"✓ Select data test passed".into());
}
...
async fn test_update_data() {
    ...
    web_sys::console::log_1(&"✓ Update data test passed".into());
}
...
async fn test_delete_data() {
    ...
    web_sys::console::log_1(&"✓ Delete data test passed".into());
}
...
async fn test_parametrized_queries() {
    ...
    let params_js = serde_wasm_bindgen::to_value(&params)
        .expect("Should serialize parameters");
    
    let result = db.execute_with_params("INSERT INTO param_test (name, score) VALUES (?, ?)", params_js).await
    ...
    let select_params_js = serde_wasm_bindgen::to_value(&select_params)
        .expect("Should serialize select parameters");
    
    let select_result = db.execute_with_params("SELECT name, score FROM param_test WHERE name = ?", select_params_js).await
    ...
    web_sys::console::log_1(&"✓ Parametrized queries test passed".into());
}
...
async fn test_multiple_data_types() {
    ...
    web_sys::console::log_1(&"✓ Multiple data types test passed".into());
}
...
async fn test_database_close() {
    ...
    web_sys::console::log_1(&"✓ Database close test passed".into());
}
